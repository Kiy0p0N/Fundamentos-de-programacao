...
A matriz triangular superior possui, além da diagonal principal preenchida, todas as outras posições acima dela.
A estratégia é identificar qual a combinação dos índice de linha e coluna.
Pensando na implementação, os valores de "i" e "j". 
